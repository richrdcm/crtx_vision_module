...
if("TRUE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /opt/crtx_vision_module/src/crtx_vision_module/fiducials/aruco_detect)
  set(aruco_detect_DEVEL_PREFIX /opt/crtx_vision_module/devel/.private/aruco_detect)
  ...
  set(aruco_detect_INSTALL_PREFIX /opt/crtx_vision_module/install)
...
if(NOT "/opt/crtx_vision_module/devel/.private/aruco_detect/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(aruco_detect_INCLUDE_DIRS "")
  set(_include_dirs "/opt/crtx_vision_module/devel/.private/aruco_detect/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/crtx_vision_module/src/crtx_vision_module/fiducials/aruco_detect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/crtx_vision_module/devel/.private/aruco_detect/lib;/opt/crtx_vision_module/devel/lib;/opt/ros/melodic/lib)
